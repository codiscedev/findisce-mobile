...
class MoneyFlowFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // Search text watcher
        etSearchTransactions.addTextChangedListener(object : android.text.TextWatcher {
    ...
    private fun createCircleDrawable(colorHex: String): android.graphics.drawable.GradientDrawable {
