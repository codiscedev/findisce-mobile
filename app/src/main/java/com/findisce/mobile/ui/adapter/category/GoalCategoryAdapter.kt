...
class GoalCategoryAdapter(
    private var categories: List<GoalCategoryResponseItem>,
    private val onItemClick: (GoalCategoryResponseItem) -> Unit
) : RecyclerView.Adapter<GoalCategoryAdapter.CategoryViewHolder>() {
    ...
    fun updateCategories(newCategories: List<GoalCategoryResponseItem>) {
