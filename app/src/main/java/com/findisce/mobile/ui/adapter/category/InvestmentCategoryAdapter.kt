...
class InvestmentCategoryAdapter(
    private var categories: List<InvestmentCategoryResponseItem>,
    private val onItemClick: (InvestmentCategoryResponseItem) -> Unit
) : RecyclerView.Adapter<InvestmentCategoryAdapter.CategoryViewHolder>() {
    ...
    fun updateCategories(newCategories: List<InvestmentCategoryResponseItem>) {
